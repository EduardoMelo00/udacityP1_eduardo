...
class Blockchain {
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
           ...
           // let diffMins = Math.floor((currentTime - timeMessage/1000)/60);
            
            let isValidBtcMsg = bitcoinMessage.verify(message, address, signature);
            ...
            if((timeMessage + (5*60*1000)) >= currentTime){
                ...
                reject("Please submit star before 5 minutes");
            }
    ...
    getBlockByHash(hash) {
        ...
        return new Promise((resolve, reject) => {
            ...
            let block = self.chain.filter(chainobj => chainobj.hash === hash)[0];
